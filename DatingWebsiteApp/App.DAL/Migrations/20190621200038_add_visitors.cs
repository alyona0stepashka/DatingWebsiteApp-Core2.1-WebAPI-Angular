        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserFromClearHistory = table.Column<DateTime>(nullable: false),
                    UserToClearHistory = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    OwnerProfileId = table.Column<string>(nullable: true),
                    VisitorId = table.Column<string>(nullable: true),
                    LastVisit = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfileVisitors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProfileVisitors_AspNetUsers_OwnerProfileId",
                        column: x => x.OwnerProfileId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProfileVisitors_AspNetUsers_VisitorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfileVisitors_OwnerProfileId",
                table: "ProfileVisitors",
                column: "OwnerProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_ProfileVisitors_VisitorId",
                table: "ProfileVisitors",
                column: "VisitorId");
